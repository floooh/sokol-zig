...
//
//    Cmdline:
//        sokol-shdc -i examples/shaders/instancing.glsl -o examples/shaders/instancing.glsl.zig -l glsl410:glsl300es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
