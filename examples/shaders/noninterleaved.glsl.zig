...
//
//    Cmdline:
//        sokol-shdc -i examples/shaders/noninterleaved.glsl -o examples/shaders/noninterleaved.glsl.zig -l glsl410:glsl300es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
