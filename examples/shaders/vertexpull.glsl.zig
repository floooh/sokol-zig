...
//
//    Cmdline:
//        sokol-shdc -i examples/shaders/vertexpull.glsl -o examples/shaders/vertexpull.glsl.zig -l glsl430:glsl310es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
