...
//
//    Cmdline:
//        sokol-shdc -i /Users/floh/projects/sokol-zig/examples/shaders/bufferoffsets.glsl -o /Users/floh/projects/sokol-zig/examples/shaders/bufferoffsets.glsl.zig -l glsl410:glsl300es:hlsl5:metal_macos:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
//    Bindings:
//
pub const ATTR_bufferoffsets_position = 0;
pub const ATTR_bufferoffsets_color0 = 1;
//
//    #version 410
//
...
pub fn bufferoffsetsAttrSlot(attr_name: []const u8) ?usize {
...
pub fn bufferoffsetsUniformblockSlot(ub_name: []const u8) ?usize {
    _ = ub_name;
    return null;
}
pub fn bufferoffsetsUniformblockSize(ub_name: []const u8) ?usize {
    _ = ub_name;
    return null;
}
pub fn bufferoffsetsUniformOffset(ub_name: []const u8, u_name: []const u8) ?usize {
    _ = ub_name;
    _ = u_name;
    return null;
}
...
pub fn bufferoffsetsStoragebufferSlot(sbuf_name: []const u8) ?usize {
    _ = sbuf_name;
    return null;
}
