...
//
//    Cmdline:
//        sokol-shdc -i examples/shaders/bufferoffsets.glsl -o examples/shaders/bufferoffsets.glsl.zig -l glsl410:glsl300es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
