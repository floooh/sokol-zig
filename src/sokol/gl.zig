...
pub inline fn asRadians(deg: f32) f32 {
    return sgl_rad(deg);
}
pub extern fn sgl_deg(f32) f32;
pub inline fn asDegrees(rad: f32) f32 {
    return sgl_deg(rad);
}
pub extern fn sgl_make_pipeline([*c]const sg.PipelineDesc) Pipeline;
pub inline fn makePipeline(desc: sg.PipelineDesc) Pipeline {
