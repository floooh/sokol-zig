...
//
//  Cmdline: sokol-shdc -i src/examples/shaders/noninterleaved.glsl -o src/examples/shaders/noninterleaved.glsl.zig -l glsl330:metal_macos:hlsl4:glsl300es:wgsl -f sokol_zig
//
//  Overview:
//
