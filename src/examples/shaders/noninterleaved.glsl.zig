...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/noninterleaved.glsl -o src/examples/shaders/noninterleaved.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
pub fn noninterleavedUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniformDesc {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
