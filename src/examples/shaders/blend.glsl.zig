...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/blend.glsl -o src/examples/shaders/blend.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'bg':
...
pub fn bgShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.entry = "main";
            desc.fs.source = &fs_bg_source_glsl410;
            desc.fs.entry = "main";
...
pub fn quadShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.source = &vs_quad_source_glsl410;
            desc.vs.entry = "main";
            ...
            desc.fs.source = &fs_quad_source_glsl410;
            desc.fs.entry = "main";
        },
        .GLES3 => {
            desc.attrs[0].name = "position";
