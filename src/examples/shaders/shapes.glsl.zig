...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/shapes.glsl -o src/examples/shaders/shapes.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
