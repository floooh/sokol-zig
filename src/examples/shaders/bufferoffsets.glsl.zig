...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/bufferoffsets.glsl -o src/examples/shaders/bufferoffsets.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
