...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/mrt.glsl -o src/examples/shaders/mrt.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'dbg':
...
pub fn dbgUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniformDesc {
    _ = ub_name;
    _ = u_name;
    return null;
}
...
pub fn fsqUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniformDesc {
    if (std.mem.eql(u8, ub_name, "fsq_params")) {
        if (std.mem.eql(u8, u_name, "offset")) {
...
pub fn offscreenUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniformDesc {
    if (std.mem.eql(u8, ub_name, "offscreen_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
            var desc: sg.ShaderUniformDesc = .{};
            desc.type = .MAT4;
