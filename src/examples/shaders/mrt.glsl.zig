...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/mrt.glsl -o src/examples/shaders/mrt.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'dbg':
...
pub fn dbgShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.entry = "main";
            desc.fs.source = &fs_dbg_source_glsl410;
            desc.fs.entry = "main";
        ...
        .D3D11 => {
            ...
            desc.vs.source = &vs_dbg_source_hlsl5;
            desc.vs.d3d11_target = "vs_5_0";
            desc.vs.entry = "main";
            desc.fs.source = &fs_dbg_source_hlsl5;
...
pub fn fsqShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.fs.source = &fs_fsq_source_glsl410;
            desc.fs.entry = "main";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = ._2D;
        ...
        .D3D11 => {
            desc.attrs[0].sem_name = "TEXCOORD";
            desc.attrs[0].sem_index = 0;
            desc.vs.source = &vs_fsq_source_hlsl5;
            desc.vs.d3d11_target = "vs_5_0";
            desc.vs.entry = "main";
            desc.vs.uniform_blocks[0].size = 16;
            desc.vs.uniform_blocks[0].layout = .STD140;
            desc.fs.source = &fs_fsq_source_hlsl5;
            desc.fs.d3d11_target = "ps_5_0";
            desc.fs.entry = "main";
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
...
pub fn offscreenShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        ...
        .D3D11 => {
            ...
            desc.vs.uniform_blocks[0].size = 64;
            desc.vs.uniform_blocks[0].layout = .STD140;
            desc.fs.source = &fs_offscreen_source_hlsl5;
            desc.fs.d3d11_target = "ps_5_0";
            desc.fs.entry = "main";
        },
        .METAL_MACOS => {
