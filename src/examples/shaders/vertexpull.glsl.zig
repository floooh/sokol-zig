...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/vertexpull.glsl -o src/examples/shaders/vertexpull.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
//
//
const vs_source_glsl300es = [357]u8 {
...
pub fn vertexpullUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniformDesc {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
