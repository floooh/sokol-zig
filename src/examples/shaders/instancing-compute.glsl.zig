...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/instancing-compute.glsl -o src/examples/shaders/instancing-compute.glsl.zig -l glsl430:glsl310es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
