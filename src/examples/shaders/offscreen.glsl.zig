...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/offscreen.glsl -o src/examples/shaders/offscreen.glsl.zig -l glsl410:glsl300es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
