...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/offscreen.glsl -o src/examples/shaders/offscreen.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
...
pub fn defaultShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.source = &vs_default_source_glsl410;
            desc.vs.entry = "main";
            ...
            desc.fs.source = &fs_default_source_glsl410;
            desc.fs.entry = "main";
        ...
        .D3D11 => {
            ...
            desc.vs.source = &vs_default_source_hlsl5;
            desc.vs.d3d11_target = "vs_5_0";
            desc.vs.entry = "main";
            desc.vs.uniform_blocks[0].size = 64;
            desc.vs.uniform_blocks[0].layout = .STD140;
            desc.fs.source = &fs_default_source_hlsl5;
